...
import { Box, Typography, Card, Divider, Icon, Tooltip, styled, Menu, MenuItem } from "@material-ui/core";
...
function ReportsBarChart({ color, title, description, date, chart, path }) {
    ...
    <MDCard  >
      <Box style={{ padding: "1rem" }}>
        ...
        <Box pt={3} pb={1} px={1}>
          ...
          <MDDes component="div" variant="h5" fontWeight="light">
            {description}
          </MDDes>
          ...
          <Box style={{ display: 'flex', justifyContent: "space-between" }}>
            <Box display="flex" alignItems="center">
              <Typography variant="h5" lineheight={1} >
                <Icon onClick={openMenu}><ScheduleIcon style={{ color: '#7b809a', fontSize: 'inherit', width: '1rem', height: '1rem' }} /></Icon>
              </Typography>
              <MDDate variant="h5" fontWeight="light">{date}</MDDate>
            </Box>
            <Box px={2} onClick={openMenu} >
