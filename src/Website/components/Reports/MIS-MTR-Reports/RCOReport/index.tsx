...
const RCOReport = (props) => {
  ...
  async function getRCOMISMTRReport(filterData) {
    const reportData: any = await ReportService.getRCOMISMTRReport(filterData);
  ...
  const formik = useFormik({
    ...
    onReset: () => {
      ...
      getRCOMISMTRReport(initialFilterValue());
    },
  });
  ...
  `}</style>
      ...
      >
        <div style={{ display: 'flex', marginTop: '2%', marginBottom: '2%' }}>
          <p className='rpthead'>
            NVBDCP - Maharashtra State - Performance of NFCU, NFSU and Night
            Clinics Data
          </p>
          <div
            style={{
          ...
          >
            <button
              ...
              onClick={() =>
                Exportpdf(
                  'table-to-xlsnew',
                  `Maharashtra State-Performance of RCO Data.pdf`,
                  'l',
                  295,
                  295
                )
            ...
            <ReactHTMLTableToExcel
              ...
              filename='Maharashtra State-Performance of RCO Data'
              sheet='Maharashtra State-Performance of RCO Data'
                  ...
                  reportTableData
                    ...
                    .map((data: any, index: any) => (
                      <tr>
                        <td>{index + 1}</td>
                        <td>{data.unitType}</td>
                        <td align='right'>{data.noUnits}</td>
                        ...
                        <td align='right'>{data.hydeocel}</td>
                      </tr>
                    ))
                ) : (
                  <tr>
