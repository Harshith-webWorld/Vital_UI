...
const FCUReport = (props) => {
  ...
  async function getFCUMISMTRReport(filterData) {
    const reportData: any = await ReportService.getFCUMISMTRReport(filterData);
  ...
  const formik = useFormik({
    ...
    onReset: () => {
      ...
      getFCUMISMTRReport(initialFilterValue());
    },
  });
  ...
  `}</style>
      ...
      >
        <div style={{ display: 'flex', marginTop: '2%', marginBottom: '2%' }}>
          <p className='rpthead'>
            NVBDCP - Maharashtra State - Performance of Filaria Control Unit
            Data
          </p>
          <div
            style={{
          ...
          >
            <button
              ...
              onClick={() =>
                Exportpdf(
                  'table-to-xlsnew',
                  `Maharashtra State-Performance of Filaria Control Unit Data.pdf`,
                  'l',
                  295,
                  295
                )
            ...
            <ReactHTMLTableToExcel
              ...
              filename='Maharashtra State-Performance of Filaria Control Unit Data'
              sheet='Maharashtra State-Performance of Filaria Control Unit Data'
