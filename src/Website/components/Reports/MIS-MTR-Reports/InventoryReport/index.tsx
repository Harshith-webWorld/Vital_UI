...
const InventoryReport = (props) => {
  ...
  async function getInventoryMISMTRReport(filterData) {
    const reportData: any = await ReportService.getInventoryMISMTRReport(
      filterData
    );
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      getInventoryMISMTRReport(values);
    ...
    onReset: () => {
      ...
      getInventoryMISMTRReport(initialFilterValue());
    },
  });
  ...
  `}</style>
      ...
      >
        <div style={{ display: 'flex', marginTop: '2%', marginBottom: '2%' }}>
          <p className='rpthead'>
            NVBDCP - Maharashtra State. Balance of Larvicide and D.E.C. Data
          </p>
          <div
            style={{
              display: 'flex',
          ...
          >
            <button
              ...
              onClick={() =>
                Exportpdf(
                  'table-to-xlsnew',
                  `NVBDCP--Maharashtra State.  Balance of Larvicide and DEC.pdf`,
                  'l',
                  295,
                  295
                )
            ...
            <ReactHTMLTableToExcel
              ...
              filename='NVBDCP--Maharashtra State.  Balance of Larvicide and DEC'
              sheet='NVBDCP--Maharashtra State.  Balance of Larvicide and DEC'
            ...
            <table id='table-to-xlsnew'>
              <thead>
                ...
                <tr>
                  ...
                  <td rowSpan={2}>Name of N.F.C.P.</td>
                  <td rowSpan={2}>Name of the Larvicide / D.E.C</td>
                  ...
                  reportTableData
                    ...
                    .map((data: any, index: any) => (
                      <tr>
                        <td>{index + 1}</td>
                        <td>{data.unitName}</td>
                        <td>{data.nameOfLarvicideDEC}</td>
                        <td align='right'>{data.openingBalance}</td>
                        <td align='right'>{data.receipt}</td>
                        <td align='right'>{data.total}</td>
                        <td align='right'>{data.consumption}</td>
