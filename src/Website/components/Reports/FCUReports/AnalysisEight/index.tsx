...
const AnalysisEight = () => {
  ...
  async function getFcuAnalysisEightData(filterData) {
    const reportData: any = await ReportService.getFcuAnalysisEight(filterData);
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      getFcuAnalysisEightData(values);
    },
    onReset: () => {
  ...
  `}</style>{' '}
      ...
      >
        ...
        <div style={{ display: 'flex', marginTop: '2%', marginBottom: '2%' }}>
          <p className='rpthead'>Monthly Comparative Statement Report</p>
          <div
            style={{
              marginLeft: 'auto',
              display: 'flex',
          ...
          >
            <button
              ...
              onClick={() =>
                Exportpdf(
                  'table-to-xlsnew',
                  `Monthly Comparative Statement Report.pdf`,
                  'l',
                  295,
                  295
                )
            ...
            <ReactHTMLTableToExcel
              ...
              filename='Monthly Comparative Statement Report'
              sheet='Monthly Comparative Statement Report'
