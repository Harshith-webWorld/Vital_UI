...
const AnalysisSix = () => {
  ...
  async function getFcuAnalysisSixData(filterData) {
    const reportData: any = await ReportService.getFcuAnalysisSix(filterData);
          ...
          >
            <button
              ...
              onClick={() =>
                Exportpdf(
                  'table-to-xlsnew',
                  `Monthly Assesment Report for B.S. Examination & MF Rate.pdf`,
                  'l',
                  295,
                  295
                )
            ...
            <ReactHTMLTableToExcel
              ...
              filename='Monthly Assesment Report for B.S. Examination & MF Rate'
              sheet='Monthly Assesment Report for B.S. Examination & MF Rate'
