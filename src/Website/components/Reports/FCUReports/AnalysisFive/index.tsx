...
const AnalysisFive = () => {
  ...
  async function getFcuAnalysisFiveData(filterData) {
    const reportData: any = await ReportService.getFcuAnalysisFive(filterData);
  ...
  `}</style>{' '}
      ...
      >
        ...
        <div style={{ display: 'flex', marginTop: '2%', marginBottom: '2%' }}>
          <p className='rpthead'>
            Monthly and Progressive MF Positive and Treatment Report
          </p>
          <div
            style={{
              marginLeft: 'auto',
          ...
          >
            <button
              ...
              onClick={() =>
                Exportpdf(
                  'table-to-xlsnew',
                  `Monthly and Progressive MF Positive and Treatment Report.pdf`,
                  'l',
                  295,
                  295
                )
            ...
            <ReactHTMLTableToExcel
              ...
              filename='Monthly and Progressive MF Positive and Treatment Report'
              sheet='Monthly and Progressive MF Positive and Treatment Report'
