...
const MonthlyStockPositionReport = (props) => {
  ...
  async function getVerticalAnalysisReport(filterData) {
    const reportData: any = await ReportService.getVerticalAnalysisReport(
      filterData
    );
  ...
  useEffect(() => {
    ...
    getVerticalAnalysisReport(data);
    getpostcontent();
    getunitOfAction();
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      getVerticalAnalysisReport(values);
    },
    onReset: () => {
      ...
      getVerticalAnalysisReport(initialFilterValue());
    },
  });
  ...
  const createpdf = () => {
    ...
    if (input) {
      html2canvas(input).then((canvas: any) => {
        ...
        doc.save(
          'Monthly Stock Position Report (Equipments, Medicine, and Larvicide).pdf'
        );
      });
    }
  };
  ...
  `}</style>
      ...
      >
        <div style={{ display: 'flex', marginTop: '2%', marginBottom: '2%' }}>
          <p className='rpthead'>
            Monthly Stock Position Report (Equipments, Medicine, and Larvicide)
          </p>
          <div
            style={{
              display: 'flex',
          ...
          >
            ...
            <ReactHTMLTableToExcel
              ...
              filename='Monthly Stock Position Report (Equipments, Medicine, and Larvicide)'
              sheet='Monthly Stock Position Report (Equipments, Medicine, and Larvicide)'
                                  ...
                                  nameOfUnitIdValues.length !== 0 ? (
                                    <Select
                                      ...
                                      onChange={(option: Option) => {
                                        ...
                                        nameOfUnitNameRef.current = option
                                          ? option.label
                                          : '';
                                      }}
                                    ></Select>
            ...
            <table id='table-to-xlsnew'>
              <thead>
                ...
                <tr>
                  ...
                  <td>
                    <b>Issue to Other in Quantity</b>
                  </td>
                  <td>
                    <b>To Whom Issued</b>
                  </td>
...
export default MonthlyStockPositionReport;
