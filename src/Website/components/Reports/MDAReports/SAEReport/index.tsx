...
const SAEReport = (props) => {
  ...
  const formik = useFormik({
    ...
    onReset: () => {
      ...
      getSaeReport(initialFilterValue());
    },
  });

  async function getSaeReport(filterData) {
    const reportData: any = await ReportService.getSaeReport(filterData);
  ...
  `}</style>
      ...
      >
        <div style={{ marginTop: '2%', display: 'flex' }}>
          <p className='rpthead'> Serious Adverse Experiences (SAE)</p>
          <div
            style={{
              display: 'flex',
              float: 'right',
          ...
          >
            <button
              ...
              onClick={() =>
                Exportpdf(
                  'table-to-xlsnew',
                  `Serious Adverse Experiences (SAE).pdf`,
                  'l',
                  295,
                  295
                )
            ...
            <ReactHTMLTableToExcel
              ...
              filename='Serious Adverse Experiences (SAE)'
              sheet='Serious Adverse Experiences (SAE)'
          ...
          <table id='table-to-xlsnew'>
            <thead>
              <tr>
                ...
                <td rowSpan={2}>No. of persons with SAE</td>
                <td colSpan={6}>Type of Reactions</td>
                <td rowSpan={2}>Clinical Outcome</td>
                <td rowSpan={2}>Required Hospital Referral</td>
                ...
                reportTableData
                  ...
                  .map((data: any, index) => (
                    <tr>
                      ...
                      <td>{data.NoOfPersonsWithSAE}</td>
                      <td>{data.noOfPersonsWithFever}</td>
                      <td>{data.noOfPersonsWithHeadache}</td>
                      <td>{data.noOfPersonsWithBodyache}</td>
                      <td>{data.noOfPersonsWithNausea}</td>
                      <td>{data.noOfPersonsWithVomiting}</td>
                      <td>{data.noOfPersonsWithOther}</td>
                      <td>
                        Recoverd : {data.noOfPersonsRecovered} / Not Recoverd :
                        {data.noOfPersonsNotRecovered}
                      </td>
                      <td>{data.requiredHospitalStay}</td>
                      <td> </td>
                    </tr>
                  ))
              ) : (
        ...
        <p>
          F - Fever,H -Headache,B -Bodyache,N - Nausea,V -Vomiting,O - Other
        </p>
      </div>
    </div>
  );
