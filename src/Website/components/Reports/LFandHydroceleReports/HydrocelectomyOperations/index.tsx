...
const HydrocelectomyOperations = (props) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      getReportHydrocelectomyOperations(values);
      setYear(values.year);
    },
    onReset: () => {
      getReportHydrocelectomyOperations({ year: `${current_year}`});
  ...
  useEffect(() => {
    ...
    getReportHydrocelectomyOperations(data);
  }, [initialFilterValue]);

  async function getReportHydrocelectomyOperations(filterData) {
    const reportData: any = await ReportService.getReportHydrocelectomyOperations(
      filterData,
    );
  ...
  `}</style>
      ...
      <div
        ...
        <div style={{ marginTop: '2%', display: 'flex' }}>
          <p className='rpthead'> Hydrocelectomy Operations</p>{' '}
          <div
            style={{
              display: 'flex',
              float: 'right',
            ...
            <ReactHTMLTableToExcel
              ...
              sheet='HydrocelectomyOperations'
          ...
          <table id='table-to-xlsnew'>
            <thead>
              ...
              <tr>
                ...
                <td>
                  <b>No Of Pending Hydrocele <br />  Cases As per {+year - 1}</b>
                </td>
                <td>
                  <b>Jan</b>
                </td>
                ...
                <td>
                  <b>Total Hydrocele Operations<br />  {year}</b>
                </td>
                <td>
                  <b>Pending Surgeries <br /> {year}</b>
                </td>
              </tr>
            </thead>
              ...
              reportTableData
                .map((item: any, index: any) => (
                  <tr>
                    ...
                    <td align='left' className={item.highlight ? "fw-bold" : ""}>{+item.totalLast}</td>
                    ...
                    <td align='left' className={item.highlight ? "fw-bold" : ""}>{calculatePending(item)}</td>
                  </tr>
                ))
            ) : (
              <tr>
...
export default HydrocelectomyOperations;
