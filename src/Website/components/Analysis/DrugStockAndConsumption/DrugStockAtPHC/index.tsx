...
const DrugStockAtPHC = () => {
  ...
  useEffect(() => {
    ...
    getDrugStockAtPHC(data);
  }, [initialFilterValue]);

  async function getDrugStockAtPHC(filterData) {
    const reportData: any = await ReportService.getDrugStockAtPHC(filterData);
  ...
  `}</style>
      ...
      >
        <div style={{ display: 'flex', marginTop: '2%', marginBottom: '2%' }}>
          <p className='rpthead'>Drug Stock PHC Wise</p>
          <div
            style={{
              display: 'flex',
              marginLeft: 'auto',
          ...
          >
            ...
            <ReactHTMLTableToExcel
              ...
              filename='Drug Stock PHC Wise'
              sheet='Drug Stock PHC Wise'
          ...
          <TableContainer>
            <table id='table-to-xlsnew'>
              <thead>
                ...
                <tr>
                  <td>Sr No.</td>
                  <td>Name Of Tablet</td>
                  <td>
                    Quantity tablet require
                    <br /> for MDA
                  </td>
                  <td>
                    Quantity tablet in
                    <br /> stock before round
                  </td>

                  <td>
                    Quantity of tablet
                    <br /> received for round
                  </td>
                  <td>
                    Quantity of tablets
                    <br /> destroyed during round
                  </td>
                  <td>
                    Quantity of balance
                    <br /> tablets in stock
                  ...
                  reportTableData
                    ...
                    .map((data: any, index: any) => {
                      return (
                        <tr key={index}>
                          <td>{index + 1}</td>
                          <td>{data.nameOfTablet}</td>
                          <td align='right'>
                            {data.quantityTabletRquireForMDA}
                          </td>
                          <td align='right'>
                            {data.quantityTabletInStockBeforeRound}
                          </td>
                          <td align='right'>
                            {data.quantityOfTabletReceivedForRound}
                          </td>
                          <td align='right'>
                            {data.quantityOfTabletsDestroyedDuringRound}
                          </td>
                          <td align='right'>
                            {data.quantityOfBalanceTabletsInStock}
                          </td>
                        </tr>
                      );
                    })
