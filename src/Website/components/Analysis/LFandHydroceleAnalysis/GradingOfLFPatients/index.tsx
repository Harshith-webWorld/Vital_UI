...
const GradingOfLFPatients = () => {
  ...
  async function getGradingOfLFPatients(filterData) {
    const reportData: any = await ReportService.getGradingOfLFPatients(
      filterData
    );
  ...
  const createpdf = () => {
    ...
    if (input) {
      html2canvas(input).then((canvas: any) => {
        ...
        doc.save('Pending Hydrocele Cases.pdf');
      });
    }
  };
  ...
  `}</style>
      ...
      >
        <div style={{ display: 'flex', marginTop: '2%', marginBottom: '2%' }}>
          <p className='rpthead'>Grading of LF patients</p>
          <div
            style={{
              display: 'flex',
              marginLeft: 'auto',
                ...
                <div>
                  ...
                  <Menu {...bindMenu(popupState)} style={{ padding: '0px' }}>
                    ...
                    <div className='form-grp'>
                      ...
                      <div className={'invalid-feedback'}>
                        {formik.errors ? formik.errors.comorbidityType : ''}
                      </div>
                    </div>
                  </div> */}
                              <div className='col-md-6 col-xl-4 col-12'>
              ...
              <tbody>
                    ...
                    .map((data: any, index) => {
                      ...
                      return (
                        <tr key={`PHC${index}`}>
                          ...
                          <td align='right'>{data.noOfCasesG1}</td>
                          <td align='right'>{data.noOfCasesG2}</td>
                          <td align='right'>{data.noOfCasesG3}</td>
                          <td align='right'>{data.noOfCasesG4}</td>
                          <td align='right'>{data.noOfCasesG5}</td>
                          <td align='right'>{data.noOfCasesG6}</td>
                          <td align='right'>{data.noOfCasesG7}</td>
                ...
                {reportTableData && reportTableData.length > 0 && (
                  <tr>
                    ...
                    <td align='right'>
                      <b>
                        {totalCountGenerator(reportTableData, 'noOfCasesG1')}
                      </b>
                    </td>
                    <td align='right'>
                      <b>
                        {totalCountGenerator(reportTableData, 'noOfCasesG2')}
                      </b>
                    </td>
                    <td align='right'>
                      <b>
                        {totalCountGenerator(reportTableData, 'noOfCasesG3')}
                      </b>
                    </td>
                    <td align='right'>
                      <b>
                        {totalCountGenerator(reportTableData, 'noOfCasesG4')}
                      </b>
                    </td>
                    <td align='right'>
                      <b>
                        {totalCountGenerator(reportTableData, 'noOfCasesG5')}
                      </b>
                    </td>
                    <td align='right'>
                      <b>
                        {totalCountGenerator(reportTableData, 'noOfCasesG6')}
                      </b>
                    </td>
                    <td align='right'>
                      <b>
                        {totalCountGenerator(reportTableData, 'noOfCasesG7')}
                      </b>
                    </td>
                    <td align='right'>
...
export default GradingOfLFPatients;
