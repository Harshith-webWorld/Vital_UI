...
const PerformanceOfInstitutes = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      get_PerformanceOfInstitutes(values);
    },
    onReset: () => {
  ...
  async function get_PerformanceOfInstitutes(filterData) {
    const reportData: any = await ReportService.getPerformanceOfInstitutes(
      filterData
    );
  ...
  useEffect(() => {
    ...
    get_PerformanceOfInstitutes(data);
  }, [initialFilterValue]);
  useEffect(() => {
    getpostcontent();
  ...
  `}</style>
      ...
      >
        ...
        <div style={{ display: 'flex', marginTop: '2%', marginBottom: '2%' }}>
          <p className='rpthead'>Performance Of Institutes</p>
          <div
            style={{
              display: 'flex',
              marginLeft: 'auto',
          ...
          >
            ...
            <ReactHTMLTableToExcel
              ...
              filename='Performance Of Institutes'
              sheet='Performance Of Institutes'
                ...
                {reportTableData && reportTableData.length > 0 ? (
                  reportTableData
                    ...
                    .map((data: any, index: any) => (
                      <tr className='row2' key={`POI1${index}`}>
                        <td>{data.districtName}</td>
                        <td>{data.nameOfControlUnit}</td>
                        <td>{data.facilityName}</td>
                        <td align='center'>{data.noOfCases}</td>
                        <td align='center'>{data.noOfSurgeriesPerformed}</td>
                        <td align='center'>{data.noOfSurgeriesPending}</td>
                      </tr>
                    ))
                ) : (
                  <tr>
...
export default PerformanceOfInstitutes;
