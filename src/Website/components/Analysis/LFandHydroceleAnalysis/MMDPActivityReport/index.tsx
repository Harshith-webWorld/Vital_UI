...
const MMDPActivityReport = () => {
  ...
  async function getMMDPActivityReport(filterData) {
    const reportData: any = await ReportService.getMMDPActivityReport(
      filterData
    );
  ...
  const createpdf = () => {
    ...
    if (input) {
      html2canvas(input).then((canvas: any) => {
        ...
        doc.save('MMDP activity reporting.pdf');
      });
    }
  };
  ...
  `}</style>
      ...
      >
        ...
        <div style={{ display: 'flex', marginTop: '2%', marginBottom: '2%' }}>
          <p className='rpthead'> MMDP Activity Reporting</p>
          <div
            style={{
              display: 'flex',
              marginLeft: 'auto',
          ...
          >
            ...
            <ReactHTMLTableToExcel
              ...
              filename='MMDP Activity Reporting'
              sheet='MMDP Activity Reporting'
            ...
            <table id='table-to-xlsnew'>
              <thead>
                ...
                <tr>
                  ...
                  <td>MMDP Trained</td>
                  <td>Balanced to be Trained</td>
                  <td>Patient Following MM</td>
                  <td>MMDP Kit Given</td>
              ...
              <tbody>
                  ...
                  reportTableData
                    ...
                    .map((data: any, index) => (
                      <tr key={`MMDPAR${index}`}>
                        ...
                        <td align='right'>{data.totalCases}</td>
                        <td align='right'>{data.followUpDone}</td>
                        <td align='right'>{data.lostToFollowUp}</td>
                        <td align='right'>{data.mmdpTrained}</td>
                        <td align='right'>{data.balancedToTrained}</td>
                        <td align='right'>
                          {
                          // data.isServicePatientFollowingMM
                          //   ? 
                            data.patientFollowingMM
                            // : '0'
                            }
                        </td>
                        <td align='right'>
                        ...
                        <td align='right'>{data.medicineGiven}</td>
                      </tr>
                    ))
                ) : (
                  <tr>
                ...
                {reportTableData && reportTableData.length > 0 && (
                  <tr>
                    ...
                    <td align='right'>
                      <b>
                        {totalCountGenerator(reportTableData, 'totalCases')}
                      </b>
                    </td>
                    <td align='right'>
                      <b>
                        {totalCountGenerator(reportTableData, 'followUpDone')}
                      </b>
                    </td>
                    <td align='right'>
                      <b>
                        {totalCountGenerator(reportTableData, 'lostToFollowUp')}
                      </b>
                    </td>
                    <td align='right'>
                      <b>
                        {totalCountGenerator(reportTableData, 'mmdpTrained')}
                      </b>
                    </td>
                    <td align='right'>
                      <b>
                    ...
                    <td align='right'>
                      <b>
                        {totalCountGenerator(reportTableData, 'mmdpKitGiven')}
                      </b>
                    </td>
                    <td align='right'>
                      <b>
                        {totalCountGenerator(reportTableData, 'medicineGiven')}
                      </b>
                    </td>
                  </tr>
                )}
...
export default MMDPActivityReport;
