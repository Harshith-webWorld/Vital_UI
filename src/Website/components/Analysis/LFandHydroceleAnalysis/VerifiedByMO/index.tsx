...
const VerifiedByMO = () => {
  ...
  async function getVerifiedbyMO(filterData) {
    const reportData: any = await ReportService.getVerifiedbyMO(filterData);
  ...
  `}</style>
      ...
      >
        ...
        <div style={{ display: 'flex', marginTop: '2%', marginBottom: '2%' }}>
          <p className='rpthead'>Verified By MO</p>
          <div
            style={{
              display: 'flex',
              marginLeft: 'auto',
          ...
          >
            ...
            <ReactHTMLTableToExcel
              ...
              filename='Verified By MO'
              sheet='Verified By MO'
                              ...
                              <div className='col-md-6 col-xl-4 col-12'>
                                ...
                                <div className='form-grp'>
                                  ...
                                  <Select
                                    ...
                                    options={
                                      genderIdList ? genderIdList : NoneList
                                    }
                                    onChange={(option: Option) => {
                                      formik.setFieldValue(
                                        'gender',
                    ...
                    .map((data: any, index) => {
                      return (
                        <tr key={`VBMO${index}S`}>
                          ...
                          <td align='right'>{data.noOfCasesVerified}</td>
                          <td align='right'>
                            {data.noOfCasesPendingVerification}
                          </td>
                        </tr>
                      );
                    })
