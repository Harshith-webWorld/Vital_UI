...
const PerformanceOfSurgeons = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      get_PerformanceOfSurgeons(values);
    },
    onReset: () => {
  ...
  async function get_PerformanceOfSurgeons(filterData) {
    const reportData: any = await ReportService.getPerformanceofsurgeons(
      filterData
    );
  ...
  useEffect(() => {
    ...
    get_PerformanceOfSurgeons(data);
  }, [initialFilterValue]);
  useEffect(() => {
    getpostcontent();
  ...
  const createpdf = () => {
    ...
    if (input) {
      html2canvas(input).then((canvas: any) => {
        ...
        doc.save('Performance of Surgeons.pdf');
      });
    }
  };
  ...
  `}</style>
      ...
      >
        ...
        <div style={{ display: 'flex', marginTop: '2%', marginBottom: '2%' }}>
          <p className='rpthead'>Performance of Surgeons</p>
          <div
            style={{
              display: 'flex',
              marginLeft: 'auto',
          ...
          >
            ...
            <ReactHTMLTableToExcel
              ...
              filename='Performance of Surgeons'
              sheet='Performance of Surgeons'
            ...
            <table id='table-to-xlsnew'>
              <thead>
                <tr>
                  ...
                  <td rowSpan={2}>Surgeries Performed</td>
                </tr>
              </thead>
              <tbody>
...
export default PerformanceOfSurgeons;
