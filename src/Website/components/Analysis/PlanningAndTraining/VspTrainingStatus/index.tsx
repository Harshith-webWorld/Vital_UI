...
const VspTrainingStatus = () => {
  ...
  useEffect(() => {
    ...
    getVspTrainingStatus(data);
  }, [initialFilterValue]);

  async function getVspTrainingStatus(filterData) {
    const reportData: any = await ReportService.getVspTrainingStatus(
      filterData
    );
  ...
  const createpdf = () => {
    ...
    if (input) {
      html2canvas(input).then((canvas: any) => {
        ...
        doc.save('Vertical Unit training status.pdf');
      });
    }
  };
  ...
  `}</style>
      ...
      >
        <div style={{ display: 'flex', marginTop: '2%', marginBottom: '2%' }}>
          <p className='rpthead'>Vertical Unit training status</p>
          <div
            style={{
              display: 'flex',
              marginLeft: 'auto',
          ...
          >
            <button
              ...
              onClick={() =>
                Exportpdf(
                  'table-to-xlsnew',
                  `Vertical Unit training status.pdf`,
                  'p',
                  210,
                  295
                )
            ...
            <ReactHTMLTableToExcel
              ...
              filename=' Vertical Unit training status'
              sheet=' Vertical Unit training status'
            ...
            >
              <thead>
                ...
                <tr>
                  ...
                  <td>Name of unit</td>
                  <td>Designation</td>
                  <td>Designation others</td>
                  <td>Type of Training</td>
                  <td>Place of Training</td>
                    ...
                    .map((data: any, index: any) => {
                      return (
                        <tr key={index}>
                          ...
                          <td>{data.designationOther}</td>
                          <td>{data.typeOfTraining}</td>
                          <td>{data.placeOfTraining}</td>
                          <td>{data.dateOfTraining}</td>
                          <td>{data.isTrained && 'Y'}</td>
                        </tr>
                      );
                    })
                ) : (
...
export default VspTrainingStatus;
