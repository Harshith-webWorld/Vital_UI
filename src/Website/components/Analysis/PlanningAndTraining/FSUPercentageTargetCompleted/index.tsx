...
const FSUPercentageTargetCompleted = () => {
  ...
  useEffect(() => {
    ...
    getFSUPercentageTargetCompleted(data);
  }, [initialFilterValue]);

  async function getFSUPercentageTargetCompleted(filterData) {
    const reportData: any = await ReportService.getFSUPercentageTargetCompleted(
      filterData
    );
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      getFSUPercentageTargetCompleted(values);
    },
    onReset: () => {
  ...
  const createpdf = () => {
    ...
    if (input) {
      html2canvas(input).then((canvas: any) => {
        ...
        doc.save('Percentage of Target Completed.pdf');
      });
    }
  };
  ...
  `}</style>
      ...
      >
        <div style={{ display: 'flex', marginTop: '2%', marginBottom: '2%' }}>
          <p className='rpthead'>Percentage of Target Completed</p>
          <div
            style={{
              display: 'flex',
              marginLeft: 'auto',
          ...
          >
            <button
              ...
              onClick={() =>
                Exportpdf(
                  'table-to-xlsnew',
                  `Percentage of Target Completed.pdf`,
                  'p',
                  210,
                  295
                )
            ...
            <ReactHTMLTableToExcel
              ...
              filename=' Percentage of Target Completed'
              sheet=' Percentage of Target Completed'
            ...
            <table id='table-to-xlsnew'>
              <thead>
                ...
                <tr>
                  ...
                  <td>Facility Name</td>
                  <td>Name of unit</td>
                  <td>Name of Village / Town</td>
                  <td>No. of Villages / Towns</td>
                  <td>Population Targeted</td>
                  <td>
                    Percentage of Population
                    <br /> Targeted
                  </td>
                  <td>Population Surveyed</td>
                  <td>No. of B.S collected</td>
                  <td>No. of B.S examined</td>
                  <td>M.F +ve cases</td>
                </tr>
              </thead>
              <tbody>
                    ...
                    .map((data: any, index: any) => {
                      return (
                        <tr key={index}>
                          ...
                          <td>{data.namesOfVillagesOrTowns}</td>
                          <td align='right'>{data.noOfVillagesOrTowns}</td>
                          <td align='right'>{data.targetedPopulation}</td>

                          <td align='right'>{data.percentageOfTarget}</td>

                          <td align='right'>{data.surveyedPopulation}</td>
                          <td align='right'>{data.noOfBSCollected}</td>
                          <td align='right'>{data.noOfBSExamined}</td>
                          <td align='right'>{data.noOfMFPositiveCases}</td>
                        </tr>
                      );
                    })
                ) : (
...
export default FSUPercentageTargetCompleted;
