...
const PlanningForOT = () => {
  ...
  useEffect(() => {
    ...
    getPlanningForOT(data);
  }, [initialFilterValue]);

  async function getPlanningForOT(filterData) {
    const reportData: any = await ReportService.getPlanningForOT(filterData);
  ...
  `}</style>
      ...
      >
        <div style={{ display: 'flex', marginTop: '2%', marginBottom: '2%' }}>
          <p className='rpthead'>Planning for OT</p>
          <div
            style={{
              display: 'flex',
              marginLeft: 'auto',
          ...
          >
            ...
            <ReactHTMLTableToExcel
              ...
              filename=' Planning for OT'
              sheet=' Planning for OT'
            ...
            <table id='table-to-xlsnew'>
              <thead>
                ...
                <tr>
                  ...
                  <td>Name of Institution OT</td>

                  <td>Headquarter</td>
                  <td>Name Of Doctor</td>
                  <td>Surgeon Or Anesthetist</td>
                  <td>
                    No Of Available
                    <br /> Surgeons
                  </td>
                  ...
                  reportTableData
                    ...
                    .map((data: any, index: any) => (
                      <tr>
                        ...
                        <td>{data.nameOfInstitutionOT}</td>
                        <td>{data.headquarter}</td>
                        <td>{data.nameOfDoctor}</td>
                        <td>{data.surgeonOrAnesthetist}</td>
                        <td align='right'>{data.noOfAvailableSurgeons}</td>
                        <td align='right'>{data.noOfAvailableAnaesthetist}</td>
                      </tr>
                    ))
                ) : (
                  <tr>
