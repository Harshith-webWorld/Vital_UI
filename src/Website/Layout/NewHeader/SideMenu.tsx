...
import { userRoleScreenActivitiesUpdate } from '../../components/WebLogin/siginslice';
        ...
        <div>
          ...
          >
            <div className='lg-block'>
              {' '}
              <i className='fa fa-bars menuButton'></i>
            </div>
          </IconButton>
                ...
                <ListGroup id='sidebarnew' as='ul'>
                  ...
                  <Accordion>
                    ...
                    <Accordion.Item eventKey='2'>
                      ...
                      <Accordion.Body>{SideBarLinks5}</Accordion.Body>
                    </Accordion.Item>
