...
export default function LFCasesGraph(props: any) {
  const [labels, setlabels] = useState<any>([]);
  const [selectedId, setselectedId] = useState<any>();
  const [tablelist, settablelist] = useState<any>([
    {
      Indicators: 'No. Of LF Cases',
    },
    {
      Indicators: 'No. of Hydrocele Cases',
    },
    {
      Indicators: 'No of Hydrocele patients operated',
    },
    {
      Indicators: 'No. Of Cases Approvals by medical officer Pending',
    },
  ]);
  ...
  let tempdatasets = [
    ...
    {
      id: 2,
      label: 'No of Hydrocele patients operated',
      pointStyle: 'rectRounded',
    ...
    {
      id: 3,
      label: 'No. Of Cases Approvals by medical officer Pending',
      pointStyle: 'rectRounded',
  ...
  const [NoOfLFCasescheck, setNoOfLFCasescheck] = useState<any>(true);
  const [
    NoOfLFCaNoofHydroceleCasessescheck,
    setNoOfLFCaNoofHydroceleCasessescheck,
  ] = useState<any>(true);
  const [
    NoofHydrocelepatientsoperatedcheck,
    setNoofHydrocelepatientsoperatedcheck,
  ] = useState<any>(true);
  const [NoOfCasesApprovalsbymoPcheck, setNoOfCasesApprovalsbymoPcheck] =
    useState<any>(true);
  ...
  const changeStatus = (id: number) => {
    return id === 0
      ? setNoOfLFCasescheck(!NoOfLFCasescheck)
      : id === 1
      ? setNoOfLFCaNoofHydroceleCasessescheck(
          !NoOfLFCaNoofHydroceleCasessescheck,
        )
      ...
      : id === 3
      ? setNoOfCasesApprovalsbymoPcheck(!NoOfCasesApprovalsbymoPcheck)
      : null;
  };
    ...
    if (response && response.data) {
          ...
          response.data
            .map((item: any) => {
              if (
                ...
                (item.NoOfLFCases !== null ||
                  item.NoOfHydroceleCases !== null ||
      ...
      response.data.map((item: any) => {
        item.NoOfLFCases !== null &&
          (temp[0] = {
            ...temp[0],
            [item.districtName]: item.NoOfLFCases,
          });
        item.NoOfHydroceleCases !== null &&
          (temp[1] = {
            ...temp[1],
            [item.districtName]: item.NoOfHydroceleCases,
          });
        item.NoOfHydroceleOperated !== null &&
          (temp[2] = {
            ...temp[2],
          ...
          <div className='card'>
            ...
            <TabContext value={value}>
              ...
              <div className='card-header'>
                <div className='row'>
                  <div className='col-md-9'>
                    <h5 className='card-title'>LF Cases</h5>
                  </div>
                </div>
              </div>
              <TabPanel value='1'>
                      ...
                      <div
                        ...
                        <label className='font-chng'>
                          <input
                            type='checkbox'
                            name='NoOfLFCases'
                            checked={NoOfLFCasescheck}
                            onChange={() =>
                              handleindicatorselect(0, NoOfLFCasescheck)
                            }
                          />
                          &nbsp; &nbsp; No. Of LF Cases
                        </label>
                        ...
                        <label className='font-chng'>
                          <input
                            type='checkbox'
                            name='NoofHydroceleCases'
                            checked={NoOfLFCaNoofHydroceleCasessescheck}
                            onChange={() => {
                        ...
                        <label className='font-chng'>
                          <input
                            type='checkbox'
                            name='NoofHydrocelepatientsoperated'
                            checked={NoofHydrocelepatientsoperatedcheck}
                            onChange={() => {
                              handleindicatorselect(
                                2,
                                NoofHydrocelepatientsoperatedcheck,
                            ...
                            value='true'
                          />
                          &nbsp; &nbsp; No of Hydrocele patients operated
                        </label>
                        <br />
                        <label className='font-chng'>
                          <input
                            type='checkbox'
                            name='NoOfCasesApprovalsbymoP'
                            checked={NoOfCasesApprovalsbymoPcheck}
                            onChange={() => {
                              handleindicatorselect(
                                3,
                                NoOfCasesApprovalsbymoPcheck,
                              );
                            }}
                            value='true'
                          />
                          &nbsp; &nbsp; No. Of Cases Approvals by medical
                          officer Pending
                        </label>
                      </div>
                      <div className='form-grp '>
